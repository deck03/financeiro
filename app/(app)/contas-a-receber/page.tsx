...
export default async function ContasAReceberPage({
  ...
  // subcategoria/contraparte/período da listagem — só o filtro de status
    ...
    <div className="space-y-6">
      ...
      {noFiltersAtAll && (
        <p className="text-sm text-ink-soft">
          ...
          <a href="/contas-a-receber?all=1" className="font-medium text-brand-accent hover:underline">
